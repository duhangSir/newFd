    ...
    <div style="width:100%;height: 100%;">
        <div style="width:100%;height: 60%;box-sizing: border-box;" class="bg_fff p_2">
            ...
            <div class="flex" style="height:90%">
                ...
                <div style="flex:1">
                    <div style="width:100%;height:300px" id="echartsPie"></div>
                </div>
            </div>
        </div>
        <el-dialog :title="'店铺' + user_id + '业绩报表'" :visible.sync="dialogVisible" width="30%">
            <div class="flex">
        ...
        <outEnterReport :user_id="user_id"></outEnterReport>
        <incomeBar :user_id="user_id"></incomeBar>
    </div>
</template>
<script>
import * as echarts from 'echarts';

import outEnterReport from './outEnterReport.vue'
import incomeBar from './incomeBar.vue'
import { allgetEverydayList, getEverydayTotal, allgetYearReportForm } from '@/api/login'
export default {
    components: { outEnterReport, incomeBar },
    props: {
        user_id: Number
    },
    data() {
    ...
    methods: {
        ...
        excelShowButton() {
            ...
            this.$JsonExcel(json_fields, this.excelData, `店铺${this.user_id}业绩报表`)
            setTimeout(() => {
